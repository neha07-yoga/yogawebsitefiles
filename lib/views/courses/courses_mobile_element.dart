...
class CoursesMobileElements extends StatelessWidget {
  final _navKey;
  CoursesMobileElements(this._navKey);
  @override
...
class MobileCourseElementCard extends StatelessWidget {
    ...
    return Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            Image.asset(imagePath, height: MediaQuery.of(context).size.width*0.2, width: MediaQuery.of(context).size.width*0.2),
            SizedBox(
              width: 5,
            ),
            Container(
